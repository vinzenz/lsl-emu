...
namespace lsl {
    TokenDef OpTokens[] = {
        ...
        TokenDef(Token::OpDecrease, TokenString("--"), TokenKind::Decrease, TokenClass::Operator),
        TokenDef(Token::OpIncrease, TokenString("++"), TokenKind::Increase, TokenClass::Operator),
        ...
        TokenDef(Token::OpNot, TokenString("!"), TokenKind::Not, TokenClass::Operator),
    };
